    ...
    <section>
        ...
        <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6x1 mx-auto ">
            <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
                <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fHww" 
                alt="key"
            ...
            <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
                <form>
                    ...
                    className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-blue-700 rounded transition ease-in-out"
                    />
                    <input type="email" id="email"
                    value={email} 
                    onChange={onChange}
                    ...
                    className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-blue-700 rounded transition ease-in-out"
                    />
                    {showPassword ? (
                ...
                <div className="flex items-center my-4 before:border-t  before:flex-1 before:border-black
                after:border-t after:flex-1  after:border-black">
